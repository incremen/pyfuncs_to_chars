constructible = {
    0: (lambda: int(not(not())), "int(not(not()))"),
    1: (lambda: int(not()), "int(not())"),
    2: (lambda: len(str(ord(min(str(not()))))), "len(str(ord(min(str(not())))))"),
    3: (lambda: len(bin(int(not()))), "len(bin(int(not())))"),
    4: (lambda: len(str(not())), "len(str(not()))"),
    5: (lambda: len(bin(len(str(not())))), "len(bin(len(str(not()))))"),
